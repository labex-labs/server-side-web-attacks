...
<p align="center">
  <a href="https://labex.io/es/courses/server-side-web-attacks">
    <img src="https://course-cover.labex.io/server-side-web-attacks.png?lang=es" alt="Ataques Web del Lado del Servidor">
  </a>
</p>
...
[Iniciar curso en LabEx](https://labex.io/es/courses/server-side-web-attacks)

## Ejercicios

|   Índice | Nombre                                                | Dificultad   | Práctica                                                                                                                                              |
|----------|-------------------------------------------------------|--------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|
|        1 | Falsificación de Solicitudes del Lado del Servidor... | Principiante | <a target='_blank' href='https://labex.io/es/labs/linux-server-side-request-forgery-ssrf-656165?course=server-side-web-attacks'>Iniciar lab</a>       |
|        2 | Inyección de Entidades Externas XML (XXE)             | Principiante | <a target='_blank' href='https://labex.io/es/labs/linux-xml-external-entity-xxe-injection-656166?course=server-side-web-attacks'>Iniciar lab</a>      |
|        3 | Fundamentos de manipulación de JWT                    | Principiante | <a target='_blank' href='https://labex.io/es/labs/linux-jwt-manipulation-basics-656164?course=server-side-web-attacks'>Iniciar lab</a>                |
|        4 | Desafío de explotación del lado del servidor          | Intermedio   | <a target='_blank' href='https://labex.io/es/labs/linux-server-side-exploitation-challenge-656163?course=server-side-web-attacks'>Iniciar desafío</a> |
